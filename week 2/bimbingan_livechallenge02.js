...
var name = 'Toni'; // silakan berikan nilai bebas
var age = 54; // silakan berikan nilai bebas
...
if (name === '') {
    ...
    if (age >= 55) {
        console.log("Anda boleh memesan steak")
        console.log("Anda mendapatkan diskon sebesar 30%")
